...
import fr.damien.forms.ConnexionForm;
...
public class Connexion extends HttpServlet implements Serializable {
     ...
     * 
     */
    private static final long  serialVersionUID          = -581952049919915970L;
    ...
    public void doPost( HttpServletRequest request, HttpServletResponse response )
        ...
        if ( utilisateurDao.confirmerMotDePasse( utilisateur.getEmail(),
